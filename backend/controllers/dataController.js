...
export const getAllData = async (req, res) => {
    try {
        const [users, classrooms, bookings, waitlist, roomBlocks, historyLogs, notifications] = await Promise.all([
        ...
        res.json({ users, classrooms, bookings, waitlist, roomBlocks, historyLogs, notifications });
    } catch (error) {
        console.error(error);
